...
#' @param add_ons Is a vector of ggplot objects that will be appended to each stick plot object.  This can be used
#'  to override or add to all the multiple stick plot objects.
