...
#'
#' @description Function creates a simple, non-scrollable static table to be laid out with other ggplot2 graphics.  The
#'  functoin is based on \code{grid} along with the \code{gtable} package.  Use \code{grid::grid.draw()} to draw the returned grob object or
#'  use \code{RplotterPkg::multi_panel_grid()} to incorporate it with other ggplot2 plot objects as shown in the demo for this function in
#'  the \code{table_graphic} folder.
#'
